...
const ENCRYPTION_KEY_RESOLVED =
  ENCRYPTION_KEY ||
  '0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef'; // dev-only fallback
...
export function encrypt(text: string): string {
  ...
  const key = crypto.scryptSync(ENCRYPTION_KEY_RESOLVED, 'salt', 32);
